...
git clone -b thirteen git@github.com:Team-NoobMaster69/vendor_motorola_hannah.git vendor/motorola/hannah
echo ""

# Kernel
echo "cloning kernel"
git clone -b hannah-337 git@github.com:Team-NoobMaster69/kernel_motorola_msm8953.git kernel/motorola/msm8953
echo ""
